...
### <a id="sohu"> 搜狐 </a>
#### 一面
- 1、	讲印象最深的项目，为什么用mongoDB？
- 2、	讲爬虫。
- 3、	讲HashMap和cocurrentHashMap。
- 4、	讲讲IOC，AOP。
- 5、	给定条件写MongoDB查找语句。
- 6、	智力题
- 7、	编程给定一个n求它的质数因子。
...
- 9、	编程二叉树深度计算。
- 10、	Mybatis中的#和$区别。
- 11、	如果输入url后出现500错误，服务器怎么解决问题。
    
----
### <a id="baidu_xiaozhao"> 百度 </a>
#### 一面
- 1、	进程和线程的区别，进程间的通信，用过哪几种？
- 2、	多态与重载。
- 3、	引用传递和值传递。
- 4、	两个栈实现队列。
- 5、	“hello new world”反转成 “world new hello”。
- 6、	中位数概念，不停的输入整数n，每输入一个计算当前队列的中位数。怎么设计？
- 7、	一个正方形游泳池的四个角各有一颗树，树的位置不能移动，如何使泳池扩大一倍并且保持正方形。
- 8、	一个4 乘 4的点阵，如何一笔画将所有点连接起来，且边数不超过6.
- 9、	现场在电脑里写快排，并运行。
